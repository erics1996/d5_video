...
g=h+"/third-party/d5video-js/d5video.js",a=h+"/third-party/d5video-js/d5video-js.min.css",d=h+"/third-party/d5video-js/d5video-js.swf";window.videojs?videojs.autoSetup():(f.loadFile(document,{id:"video_css",tag:"link",rel:"stylesheet",type:"text/css",href:a}),f.loadFile(document,{id:"video_js",src:g,tag:"script",type:"text/javascript"},function(){videojs.options.flash.swf=d;videojs.autoSetup()}))}})})();
