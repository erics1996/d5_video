...
(function(){
    ...
    function initVideo(){
        ...
        (function(){
            ...
            if(img && img.className){
                var hasFakedClass = (img.className == "edui-faked-d5video"),
                    hasUploadClass = img.className.indexOf("edui-upload-d5video")!=-1;
    ...
    function convert_url(url){
        ...
        url = utils.trim(url)
            ...
            .replace(/v\.qq\.com\/cover\/[\w]+\/[\w]+\/([\w]+)\.html/i, "static.d5video.qq.com/TPout.swf?vid=$1")
            .replace(/v\.qq\.com\/.+[\?\&]vid=([^&]+).*$/i, "static.d5video.qq.com/TPout.swf?vid=$1")
